...
# git submodule add https://github.com/mchehab/zbar.git src/nimQR/private/zbar
# git submodule add https://github.com/nayuki/QR-Code-generator.git src/nimQR/private/qrcodegenerator
